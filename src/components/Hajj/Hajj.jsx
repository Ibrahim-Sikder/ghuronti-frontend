...
import First from '../../../src/images/hajjPackageOne.png'
import Second from '../../../src/images/hajjPackageTwo.png'
import Third from '../../../src/images/hajjPackageThree.png'
    ...
    return (
        <div className=''>
            ...
            <div className="home-main">
                <h1 className="titleHero">Welcome to Ghuronti! Find Tours, Flights & Hotels Packages</h1>
                <div className="heroBoxMain">
                    <div className="optionsOfHero">
                        <div className="hajjbuttonActive">
                            <svg
                    ...
                    <div className="heroboxContent">
                        <div className="hajjPackage">
                            <div className="hajjPackageButton" onClick={() => setHazzSubBUttonActive(0)}>
                                <p className="hajjButtonSubActive" style={{ borderBottom: hazzSubButtonActive === 0 ? "3px solid #4AB449" : "none" }}>Hajj Packages</p>
                            </div>
                            <div className="hajjPackageButton" onClick={() => setHazzSubBUttonActive(1)}>
                                <p className="hajjButtonSubActive" style={{ borderBottom: hazzSubButtonActive === 1 ? "3px solid #4AB449" : "none" }}>Umrah Packages</p>
                            </div>
                        </div>
                        <div className="hajjPackagesButton">
                            <button className="bookButton">Get Your Offers</button>
                        </div>
                    </div>
                </div>
                <div className="mainContent">
                    <div className="hajjMain">
                        <h1>Best Hajj Packages 2023 from bangladesh</h1>
                        <p className="hajjMainPara">Some of the renowned and best Hajj agencies in Bangladesh are <br /> Universal Travel & Tours, Holy Hajj & Umrah</p>
                        <div className="hajjPackages">
                            {
                                data && data.map((item, index) => (
                                    <div className="packageBox" key={index}>
                                        <img src={item.image} alt='' className="hajjPackageCOverImage" />
                                        <p className="packageTitle">{item.name}</p>
                                        {
                                            item.facility && item.facility.map((items, index) => (
                                                <div key={index} className="facilityMain">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width={20}
                                                        height={20}
                        ...
                        <p className="hajjMainPara">Non-resident & Resident Bangladeshi adults and children can <br /> apply for hajj pre-registration through the Hajj agency.</p>
                        <div className="preRegReq">
                            <div className="req">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width={24}
